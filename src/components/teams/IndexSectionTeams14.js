...
export default function IndexSectionTeams14() {
    return (
        <React.Fragment>
            <>
                <section className="bg-white overflow-hidden pt-8 md:pt-20 pb-8 md:pb-32">
  <div className="container px-4 mx-auto">
    <h2 className="mb-5 md:text-8xl xl:text-10xl text-center font-heading tracking-px-n leading-none font-semibold text-purple-900 text-5xl tracking-px-n mx-auto md:max-w-4xl">Moodui s'adapte à votre secteur d'activité</h2>
    ...
    <div className="flex flex-wrap max-w-7xl mx-auto -m-3">
      <div className="w-full md:w-1/2 lg:w-1/4 p-3">
        <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
          <img className="h-full object-cover transform hover:scale-105 transition ease-in-out duration-1000" src="https://static.shuffle.dev/uploads/files/c9/c92bf0a83b0e3f1d28caf7c9c05d33704a901e05/brooke-cagle-8jp-6SjVibM-unsplash.jpg" alt />
          <div className="absolute bottom-0 left-0 w-full p-2">
            <div className="bg-black bg-opacity-80 w-full py-4 px-5 rounded-lg" style={{backdropFilter: 'blur(3px)'}}>
              <h3 className="mb-1 text-lg text-white font-bold leading-snug">Commerçants</h3>
              <p className="text-gray-400 font-medium">Prise de commande, menus, abonnement fidélité, ...</p>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 p-3">
        <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
          <img className="h-full object-cover transform hover:scale-105 transition ease-in-out duration-1000" src="https://static.shuffle.dev/uploads/files/c9/c92bf0a83b0e3f1d28caf7c9c05d33704a901e05/olawale-munna-ObjhzjnMmc-unsplash.jpg" alt />
          <div className="absolute bottom-0 left-0 w-full p-2">
            <div className="bg-black bg-opacity-80 w-full py-4 px-5 rounded-lg" style={{backdropFilter: 'blur(3px)'}}>
              <div className>
                <h3 className="mb-1 text-lg text-white font-bold leading-snug">Artisans et consultants</h3>
                <p className="text-gray-400 font-medium">Demande de devis, question produit, avis client, ...</p>
              </div>
              <div className="flex wrap items-center -m-2.5 hidden">
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 p-3">
        <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
          <img className="h-full object-cover transform hover:scale-105 transition ease-in-out duration-1000" src="https://static.shuffle.dev/uploads/files/c9/c92bf0a83b0e3f1d28caf7c9c05d33704a901e05/sofia-mQtcrK22CN8-unsplash.jpg" alt />
          <div className="absolute bottom-0 left-0 w-full p-2">
            <div className="bg-black bg-opacity-80 w-full py-4 px-5 rounded-lg" style={{backdropFilter: 'blur(3px)'}}>
              <h3 className="mb-1 text-lg text-white font-bold leading-snug">Immobilier et agences</h3>
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 p-3">
        <div className="relative max-w-max mx-auto h-full overflow-hidden rounded-3xl">
          <img className="h-full object-cover transform hover:scale-105 transition ease-in-out duration-1000" src="https://static.shuffle.dev/uploads/files/c9/c92bf0a83b0e3f1d28caf7c9c05d33704a901e05/vitaly-gariev-YuO3d4XS6yw-unsplash.jpg" alt />
          <div className="absolute bottom-0 left-0 w-full p-2">
            <div className="bg-black bg-opacity-80 w-full py-4 px-5 rounded-lg" style={{backdropFilter: 'blur(3px)'}}>
              <h3 className="mb-1 text-lg text-white font-bold leading-snug">Équipes marketing</h3>
